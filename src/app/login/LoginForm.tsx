...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="relative w-full max-w-4xl bg-gray-900 border border-gray-800 rounded-3xl shadow-2xl overflow-hidden animate-fade-in">
        {/* Decorative gradient bar */}
        <div className="h-1.5 w-full bg-gradient-to-r from-orange-500 via-purple-500 to-blue-500" />
        ...
        <div className="p-8 md:p-10">
          ...
          {step === 'role' ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
              {ROLES.map((role) => (
                <button
                  ...
                  className={`flex flex-col items-center gap-3 p-4 rounded-2xl border ${role.border} bg-gray-950 hover:bg-gray-850 transition-all group hover:scale-105 cursor-pointer`}
                >
            ...
            <div className="max-w-md mx-auto">
              {/* Selected Role Badge */}
              <div className={`flex items-center gap-3 p-3 rounded-xl border ${selectedRole.border} bg-gray-950 mb-6`}>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-custom-orange placeholder-gray-600"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 pr-11 text-sm text-white focus:outline-none focus:ring-2 focus:ring-custom-orange placeholder-gray-600"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                {/* Demo hint */}
                <div className="bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 text-xs text-gray-500 leading-relaxed">
