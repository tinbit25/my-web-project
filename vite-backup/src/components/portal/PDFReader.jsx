...
export default function PDFReader({ file, title, chapterId, onClose }) {
  ...
  const handleSaveProgress = (percentage) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-2 md:p-6">
      <div className="relative bg-gray-900 rounded-2xl shadow-2xl w-full h-full max-w-6xl max-h-[92vh] flex flex-col overflow-hidden border border-gray-800 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between px-6 py-4 bg-gray-850 border-b border-gray-800 gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-bold text-sm md:text-base tracking-wide">{title || 'PDF Study Guide'}</h3>
          ...
          <div className="flex items-center flex-wrap gap-2">
            {/* Zoom Controls */}
            <div className="flex items-center bg-gray-900 border border-gray-850 rounded-xl p-1 gap-1">
              <button
            ...
            <select
              ...
              className="bg-gray-900 border border-gray-850 text-gray-300 text-xs font-semibold rounded-xl px-3 py-2.5 focus:outline-none"
            >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 md:static p-2.5 text-gray-400 hover:text-white bg-gray-800 hover:bg-gray-700 rounded-xl transition-all"
