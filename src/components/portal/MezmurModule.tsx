...
export default function MezmurModule() {
  ...
  const [playingSong, setPlayingSong] = useState<Mezmur | null>(null);
  const [isPlaying, setIsPlaying] = useState(false);
  const [showLyrics, setShowLyrics] = useState<Mezmur | null>(null);
  ...
  const handlePlaySong = (song: Mezmur) => {
    setPlayingSong(song);
    setIsPlaying(true);
  };
