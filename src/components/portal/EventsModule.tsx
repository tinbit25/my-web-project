            ...
            {regDone ? (
              ...
              <div className="p-8 text-center space-y-4">
                ...
                <p className="text-xs text-gray-400 leading-relaxed max-w-xs mx-auto">
                  <strong className="text-white">{regName}</strong> has been registered for{' '}
                  <strong className="text-white">{registering.title}</strong>. You will receive a notification reminder before the event.
                </p>
                <button
                  onClick={closeModal}
