      ...
      <nav className="relative">
        ...
        <div className="hidden lg:flex justify-center items-center p-3">
          <ul className="flex space-x-4 xl:space-x-8 items-center">
            ...
            <li>
              <button className={navLinkClass} onClick={onEnterPortal}>
                STUDENT PORTAL
                <span className={underline} />
              </button>
            </li>
        ...
        <div className="lg:hidden flex justify-end p-5">
          <button onClick={toggleMenu} className="menu-btn" aria-label="Toggle menu">
            <FontAwesomeIcon
        ...
        >
          ...
          <ul className="space-y-4">
            ...
            <li>
              <button
                onClick={() => { toggleMenu(); onEnterPortal(); }}
                className={mobileLinkClass}
              >
                STUDENT PORTAL
              </button>
