...
export default function Section3() {
  return (
    <div className="section3 flex flex-col md:flex-row items-center p-6 md:p-12 bg-gray-100 text-gray-900">
      <div className="relative md:w-1/2">
        <img
          src="/images/photo_2023-02-22_15-44-45.jpg"
          alt="Church Image"
          className="w-full h-auto rounded-md shadow-md mb-10"
        />
      </div>
      <div className="rtnote md:w-1/2 md:ml-8 mt-6 md:mt-0 md:pt-4 md:border-t-4 md:border-custom-orange">
