...
const GRADE_CURRICULUM = {
  5: [
    {
      id: 'g5-c1', title: 'Introduction to the Holy Bible', amharic: 'ወደ ቅዱስ መጽሐፍ መግቢያ',
      lessons: [
      ...
      quizzes: [{
        id: 'g5-c1-q1', title: 'Bible Basics Quiz',
        questions: [
          { type: 'mc', question: 'How many books does the EOTC canon include?', options: ['66', '73', '81', '39'], answer: 2 },
          { type: 'tf', question: 'The Book of Enoch is included in the Ethiopian Orthodox canon.', answer: true },
          { type: 'fib', question: 'The first book of the Holy Bible is called ____.', answer: 'Genesis' },
        ]
      }]
    },
    {
      id: 'g5-c2', title: 'Praise & Worship (Mahlet)', amharic: 'ምስጋናና ማኅሌት',
      lessons: [
    ...
    {
      id: 'g5-c3', title: 'Lives of the Saints', amharic: 'ገድለ ቅዱሳን',
      lessons: [
  ...
  6: [
    {
      id: 'g6-c1', title: 'The Life of Jesus Christ', amharic: 'የኢየሱስ ክርስቶስ ሕይወት',
      lessons: [
      ...
      quizzes: [{
        id: 'g6-c1-q1', title: 'Life of Christ Quiz',
        questions: [
          { type: 'mc', question: 'Where was Jesus Christ born?', options: ['Jerusalem', 'Nazareth', 'Bethlehem', 'Galilee'], answer: 2 },
    ...
    {
      id: 'g6-c2', title: 'Ten Commandments & Mosaic Law', amharic: 'አሥርቱ ትእዛዛት',
      lessons: [
    ...
    {
      id: 'g6-c3', title: 'Church Architecture & Symbolism', amharic: 'የቤተ ክርስቲያን ሕንፃ',
      lessons: [
  ...
  7: [
      ...
      quizzes: [
        {
          ...
          questions: [
            { type: 'mc', question: 'Who baptized Jesus Christ in the River Jordan?', options: ['Simon Peter', 'John the Baptist', 'Paul the Apostle', 'Moses'], answer: 1 },
            { type: 'tf', question: 'In EOTC tradition, the Bible contains 81 canonized books.', answer: true },
            { type: 'fib', question: 'The Covenant of Abraham was sealed through the rite of ____.', answer: 'circumcision' },
          ]
        }
      ]
    },
    {
      id: 'g7-c2', title: 'Church History', amharic: 'የቤተክርስቲያን ታሪክ',
      lessons: [
    ...
    {
      id: 'g7-c3', title: 'Mezmur Chant & Liturgy', amharic: 'የቅዳሴና የመዝሙር ጥናት',
      lessons: [
        { id: 'g7-c3-l1', title: 'The Geez vocal mode and Yaredic notations', file: '/documents/sample.pdf' }
      ]
    }
  ],
  8: [
    {
      id: 'g8-c1', title: 'Dogmatic Theology (Haymanot)', amharic: 'ዶግማ — ሃይማኖት',
      lessons: [
      ...
      quizzes: [{
        id: 'g8-c1-q1', title: 'Dogmatic Theology Quiz',
        questions: [
          { type: 'mc', question: 'The EOTC holds which Christological position?', options: ['Dyophysitism', 'Nestorianism', 'Miaphysitism', 'Arianism'], answer: 2 },
    ...
    {
      id: 'g8-c2', title: 'Sacraments (Mysteries)', amharic: 'ሰባቱ ምሥጢራት',
      lessons: [
    ...
    {
      id: 'g8-c3', title: 'Ethiopian Ecclesiastical Calendar', amharic: 'የቤተ ክርስቲያን አቆጣጠር',
      lessons: [
  ...
  9: [
    {
      id: 'g9-c1', title: 'Canon Law & Church Administration', amharic: 'ቀኖና ቤተ ክርስቲያን',
      lessons: [
      ...
      quizzes: [{
        id: 'g9-c1-q1', title: 'Church Administration Quiz',
        questions: [
          { type: 'mc', question: 'What is the highest office in the EOTC?', options: ['Deacon', 'Priest', 'Patriarch', 'Archbishop'], answer: 2 },
    ...
    {
      id: 'g9-c2', title: 'Yared & Sacred Music', amharic: 'ቅዱስ ያሬድና ቅዱስ ዜማ',
      lessons: [
    ...
    {
      id: 'g9-c3', title: 'Fasting & Prayer Traditions', amharic: 'ጾምና ጸሎት',
      lessons: [
  ...
  10: [
    {
      id: 'g10-c1', title: 'Biblical Hermeneutics', amharic: 'የቅዱሳት መጻሕፍት ትርጓሜ',
      lessons: [
      ...
      quizzes: [{
        id: 'g10-c1-q1', title: 'Hermeneutics Quiz',
        questions: [
          { type: 'mc', question: 'Which language was the New Testament originally written in?', options: ['Latin', 'Hebrew', 'Greek', 'Aramaic'], answer: 2 },
          { type: 'tf', question: 'The Ge\'ez Bible (Haile Selassie translation) is called Mashaf Qidus.', answer: true },
          { type: 'fib', question: 'Typology refers to seeing people in the Old Testament as ____ of Christ.', answer: 'types' },
        ]
      }]
    },
    {
      id: 'g10-c2', title: 'Ethics & Christian Living', amharic: 'ክርስቲያናዊ ሕይወት',
      lessons: [
    ...
    {
      id: 'g10-c3', title: 'History of African Christianity', amharic: 'የአፍሪካ ክርስትና ታሪክ',
      lessons: [
  ...
  11: [
    {
      id: 'g11-c1', title: 'Advanced Theology (Metsehafe Berhan)', amharic: 'መጸሐፈ ብርሃን',
      lessons: [
      ...
      quizzes: [{
        id: 'g11-c1-q1', title: 'Advanced Theology Quiz',
        questions: [
          { type: 'mc', question: 'How many Anaphoras does the EOTC Liturgy contain?', options: ['3', '7', '14', '21'], answer: 2 },
    ...
    {
      id: 'g11-c2', title: 'Ecumenism & World Religions', amharic: 'ሐይማኖቶች ዓለም',
      lessons: [
    ...
    {
      id: 'g11-c3', title: 'Leadership & Diaconal Ministry', amharic: 'ዲቆናዊ አገልግሎት',
      lessons: [
  ...
  12: [
    {
      id: 'g12-c1', title: 'Eschatology — Last Things', amharic: 'ስለ ቅጻለ ዓለም',
      lessons: [
      ...
      quizzes: [{
        id: 'g12-c1-q1', title: 'Eschatology Final Quiz',
        questions: [
          { type: 'mc', question: 'Which book of the EOTC describes the fate of fallen angels?', options: ['Jubilees', 'Book of Enoch', 'Tobit', 'Esdras'], answer: 1 },
    ...
    {
      id: 'g12-c2', title: 'Senior Capstone: Theological Essay', amharic: 'ከፍተኛ ሥነ-ሃይማኖት',
      lessons: [
    ...
    {
      id: 'g12-c3', title: 'Full Kidase Participation', amharic: 'ሙሉ ቅዳሴ',
      lessons: [
...
export default function StudentView({ activeTab, setActiveTab }) {
    ...
    <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-orange-600/20 to-purple-600/20 border border-orange-500/30 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-300 mt-0.5">You have completed over 90% of the Sunday School syllabus program.</p>
                </div>
              </div>
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4 divide-y divide-gray-850">
                <div className="pt-3 first:pt-0">
                  ...
                  <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                    All class attendees are invited to the upcoming spiritual retreat at Debre Berhan. Registration is now open on the Events board.
                  </p>
                </div>
                <div className="pt-3">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 flex flex-col justify-between min-h-[250px]">
              ...
              <button
                ...
                className="w-full py-2.5 bg-gray-850 hover:bg-gray-850 text-gray-300 hover:text-white rounded-xl text-xs font-bold border border-gray-800 transition-colors mt-6 cursor-pointer"
              >
          ...
          <div className="flex bg-gray-900 p-2.5 rounded-2xl border border-gray-800 items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex gap-1.5 overflow-x-auto">
              {[5, 6, 7, 8, 9, 10, 11, 12].map(g => (
                <button
                  key={g}
                  onClick={() => { setSelectedGrade(g); setActiveCourse(null); }}
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-6">
              <div className="flex items-center justify-between border-b border-gray-850 pb-4">
                <div>
                  ...
                  >
                    ← Back to Grade {selectedGrade} courses
                  </button>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {activeCourse.lessons?.map(les => (
                    <div key={les.id} className="bg-gray-950 border border-gray-850 rounded-xl p-4 flex items-center justify-between gap-4 group">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-lg bg-red-500/10 text-red-500 flex items-center justify-center flex-shrink-0">
                          <FontAwesomeIcon icon={faFilePdf} />
                        </div>
                        <div>
                          <h5 className="text-xs font-bold text-white leading-snug group-hover:text-custom-orange transition-colors">{les.title}</h5>
              ...
              {activeCourse.quizzes?.length > 0 && (
                <div className="space-y-4 pt-4 border-t border-gray-850">
                  <h4 className="text-xs font-extrabold uppercase tracking-wider text-gray-400">Course Assessment Quizzes</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {activeCourse.quizzes.map(qz => (
                      <div key={qz.id} className="bg-gray-950 border border-gray-850 rounded-xl p-4 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="text-[9px] text-gray-500 font-semibold">{qz.questions.length} Questions</span>
                          </div>
                        </div>
                        <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.length === 0 ? (
                <div className="col-span-full text-center text-gray-500 bg-gray-900 border border-gray-800 rounded-2xl py-12">
                  <p className="text-sm">Curriculum syllabus details for Grade {selectedGrade} is currently being compiled by administrators.</p>
                </div>
              ) : (
                courses.map(crs => (
                  <div
      ...
      {activeQuiz && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 p-4">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl w-full max-w-xl max-h-[85vh] flex flex-col overflow-hidden">
            {/* Header */}
            <div className="bg-gray-850 px-6 py-4 border-b border-gray-800 flex items-center justify-between">
              ...
              <button onClick={() => setActiveQuiz(null)} className="text-gray-400 hover:text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="relative bg-white text-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl p-8 border-[12px] border-amber-800 flex flex-col justify-between items-center text-center gap-6 min-h-[450px] overflow-hidden">
            ...
            <div className="flex items-center justify-between w-full z-10">
              ...
              <button onClick={() => setShowCertificate(false)} className="text-gray-400 hover:text-gray-950 font-bold p-1">
                <FontAwesomeIcon icon={faTimes} />
              </button>
            </div>

            <div className="space-y-3 z-10">
              <h2 className="text-2xl md:text-3xl font-serif text-amber-950 font-extrabold uppercase tracking-wide">Certificate of Achievement</h2>
              <p className="text-xs text-amber-800 font-semibold tracking-wider italic uppercase mt-1">This is proudly presented to</p>
              <h3 className="text-3xl md:text-4xl font-serif text-gray-900 font-bold py-2 underline decoration-amber-700 decoration-2">Tinbit Elias</h3>
              <p className="text-xs text-gray-600 max-w-lg mx-auto leading-relaxed mt-2">
                For successfully fulfilling and completing the Sunday School theological, historical, and liturgical course examinations of <strong>Grade 7 Curriculum Syllabus</strong>.
              </p>
            </div>
