...
export default function SuperAdminView({ activeTab, setActiveTab }) {
  const [selectedParish, setSelectedParish] = useState('debre_berhan');
  const data = PARISH_DATA[selectedParish] || PARISH_DATA.debre_berhan;

  const [parishes, setParishes] = useState(Object.keys(PARISH_DATA));
