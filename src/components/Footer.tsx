...
export default function Footer() {
  ...
  const btnLinkClass =
    'text-gray-300 hover:text-orange-400 transition-colors text-sm cursor-pointer bg-transparent border-0 p-0 text-left';

  return (
    <>
      <footer className="bg-gray-900 text-white pt-12 pb-6 px-4 lg:px-12 w-full">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Sunday School of the Ethiopian Orthodox Tewahedo Church, Debre Berhan — nurturing faith and knowledge for
              future generations.
            </p>
            {/* Social Icons */}
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => setShowCalendar(true)} className={btnLinkClass}>
                  Academic Calendar
                </button>
              </li>
              <li>
        ...
        <div className="max-w-screen-xl mx-auto border-t border-gray-700 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Gbi Gubae — Ethiopian Orthodox Tewahedo Church Sunday School
          </p>
          <p className="text-gray-650 text-xs">Built with ❤️ for the community</p>
        </div>
      </footer>
