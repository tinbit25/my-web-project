...
export default function PortalLayout({ initialRole = 'student' }: PortalLayoutProps) {
  ...
  const renderContent = () => {
    ...
    switch (activeRole) {
      case 'student':    return <StudentView    activeTab={activeTab} setActiveTab={setActiveTab} />;
      case 'teacher':    return <TeacherView    activeTab={activeTab} setActiveTab={setActiveTab} />;
      case 'admin':      return <AdminView      activeTab={activeTab} setActiveTab={setActiveTab} />;
      case 'superadmin': return <SuperAdminView activeTab={activeTab} setActiveTab={setActiveTab} />;
      case 'parent':     return <ParentView     activeTab={activeTab} setActiveTab={setActiveTab} />;
      default:           return <div className="text-white p-6">Under Construction</div>;
    }
  };
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col font-sans">
      ...
      <header className="bg-gray-900 border-b border-gray-800 h-16 flex items-center justify-between px-6 z-30 sticky top-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={() => router.push('/')}
            className="flex items-center gap-2 px-3 py-2 bg-red-700 hover:bg-red-800 text-white rounded-lg text-xs font-bold transition-all shadow-md shadow-red-900/10 cursor-pointer"
          >
